...
export default function Hero() {
    ...
    return (
        ...
        <section className={"mt-4 flex flex-col items-center justify-center px-4 text-white"} id="inicio">
            ...
            <video autoPlay loop muted className="absolute h-full w-1/2 rounded-3xl object-cover">
            ...
            <h1 className="text-center text 4x1 font-bold mix-blend-difference md:text-8xl">BIENVENIDO</h1>
